<template>
  <div class="deal-card flex items-center justify-between">
    <div class="deal-info">
      ...
      <span v-if="deal" class="inline-flex shrink-0 items-center rounded-full bg-green-600/50 mt-1 px-2 py-0.5 text-lg font-medium text-green-200 ring-1 ring-green-200 ring-inset">{{ deal.distance }} km</span>
    </div>
    ...
    <div class="restaurant-info flex items-center justify-end">
      <button class="action-button" @click="openDrawer">
        <v-icon name="io-ellipsis-vertical" class="action-icon drop-shadow-[0_5px_5px_rgba(0,0,0,0.5)]" />
